import { createScene, UserWorld, useWorld } from "@repo/engine";
...
function createShapes() {
  ...
  for (let i = 0; i < 5; i++) {
    ...
    world.add(smallShape, new Shape(
