...
export function initialize(element: HTMLElement) {
  element.innerHTML = /* html */`
    <aside class="fixed top-2.5 right-2.5 flex flex-col gap-2 p-2.5 rounded-lg font-mono text-xs select-none pointer-events-none z-[9999] bg-black/90 text-white w-[300px] data-[mode=simple]:w-auto data-[mode=simple]:flex-row data-[mode=simple]:items-center data-[mode=simple]:gap-1 data-[mode=simple]:px-2 data-[mode=simple]:py-0.5 data-[mode=simple]:h-5" data-mode="default">
      ...
      <div class="flex justify-between h-[100px] data-[mode=simple]:hidden" data-mode-view="default">
        ...
        <div class="flex flex-col justify-between w-[55%]">
            <div class="flex items-center h-4 gap-1">
                <span class="w-[30px] text-[10px] text-left text-gray-300">AVG</span>
                ...
                <span id="val-avg" class="w-[25px] text-[10px] text-right font-bold">0</span>
            </div>
            <div class="flex items-center h-4 gap-1">
                <span class="w-[30px] text-[10px] text-left text-gray-300">MAX</span>
                ...
                <span id="val-max" class="w-[25px] text-[10px] text-right font-bold">0</span>
            </div>
            <div class="flex items-center h-4 gap-1">
                <span class="w-[30px] text-[10px] text-left text-gray-300">MIN</span>
                ...
                <span id="val-min" class="w-[25px] text-[10px] text-right font-bold">0</span>
            </div>
            <div class="flex items-center h-4 gap-1">
                <span class="w-[30px] text-[10px] text-left text-gray-300">1%</span>
                ...
                <span id="val-1low" class="w-[25px] text-[10px] text-right font-bold">0</span>
            </div>
            <div class="flex items-center h-4 gap-1">
                <span class="w-[30px] text-[10px] text-left text-gray-300">0.1%</span>
                ...
                <span id="val-01low" class="w-[25px] text-[10px] text-right font-bold">0</span>
            </div>
        </div>
      </div>
      ...
      <div class="hidden data-[mode=advanced]:flex flex-col gap-2.5 mt-1" data-mode-view="advanced">
        <div class="flex flex-col gap-1">
          <div class="flex items-center gap-2">
            <span class="text-[11px] font-bold w-[30px] text-gray-400">FPS</span>
        ...
        <div class="flex flex-col gap-1">
          <div class="flex items-center gap-2">
            <span class="text-[11px] font-bold w-[30px] text-gray-400">UPS</span>
