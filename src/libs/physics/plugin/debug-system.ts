...
import { getEntityCollider } from "@lib/physics/entity/get";
import { ColliderDebugProxy } from "@lib/physics/plugin/components/collider-debug-proxy";
import { debugStateSchema, type PhysicsDebugOpts } from "@lib/physics/plugin/types";
