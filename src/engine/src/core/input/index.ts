import type { KeyBind } from "@engine/systems/input/keybind";
import { EngineMouseEvent, type EngineInputHost, type EngineMouseEventName } from "@engine/core/input/mouse";
...
export { EngineMouseEvent, getEntityAtPoint } from "@engine/core/input/mouse";
export type { EngineInputHost, EngineMouseEventName, EntityAtPointOptions, Point2D } from "@engine/core/input/mouse";
