...
import colorFragmentShaderSource from "@engine/render/renderers/webGL/shaders/color.frag";
import colorVertexShaderSource from "@engine/render/renderers/webGL/shaders/color.vert";
