...
export class ConveyorMathUtils {
  public static dotNormalized(ax: number, ay: number, bx: number, by: number): number {
  ...
  public static setNormalized(out: Vec2, x: number, y: number, fallback: Vec2): void {
