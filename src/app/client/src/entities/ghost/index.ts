...
export { GhostPreviewScopeUtils } from "@client/entities/ghost/GhostPreviewScopeUtils";
export { createEntityGhostPreset, spawnGhost } from "@client/entities/ghost/spawner";
