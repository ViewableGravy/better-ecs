...
import { useContextManager } from "@lib/spatial-contexts";
import { HOUSE_INTERIOR, HOUSE_ROOF, OUTSIDE, RenderVisibility } from "@client/scenes/world/components/render-visibility";
...
export const DebugOverlaySystem = createSystem("main:spatial-contexts-debug")({
  system() {
    ...
    const world = manager.requireWorld(focused);
