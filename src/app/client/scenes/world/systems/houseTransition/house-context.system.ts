...
import { ContextFocusBlendTransitionMutator } from "@client/scenes/world/systems/houseTransition/contextTransitionMutator";
import {
  createSystem,
  type EntityId,
  type UserWorld,
...
import { ContextEntryRegion, type ContextId, useContextManager } from "@lib/spatial-contexts";
