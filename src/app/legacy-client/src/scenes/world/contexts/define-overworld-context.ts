...
} from "@legacy/components/conveyor-belt";
import { spawnDemoShaderQuad } from "@legacy/entities/demo-shader-quad";
import { spawnDoor } from "@legacy/entities/door";
import { spawnGear } from "@legacy/entities/gear";
import { spawnHouse } from "@legacy/entities/house";
import { spawnOreField } from "@legacy/entities/ore-field";
import {
    ConveyorUtils,
    spawnTransportBelt,
...
import { spawnTree } from "@legacy/entities/tree";
import { spawnWall } from "@legacy/entities/wall";
import { setupContextPlayer } from "@legacy/scenes/world/contexts/shared";
import { createHouseLayout } from "@legacy/scenes/world/utilities/house-layout";
