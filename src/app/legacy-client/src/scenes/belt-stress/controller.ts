...
import type { BeltStressRendererConfiguration } from "@legacy/scenes/belt-stress/render/BeltStressRenderer";
import BeltStressSimulationWorker from "@legacy/scenes/belt-stress/simulation.worker?worker";
