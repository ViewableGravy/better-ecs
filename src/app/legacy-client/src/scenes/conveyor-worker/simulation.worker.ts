...
import type { ConveyorRequest, ConveyorResponse } from "@legacy/scenes/conveyor-worker/protocol";
import { ConveyorSimulation } from "@legacy/scenes/conveyor-worker/simulation";
