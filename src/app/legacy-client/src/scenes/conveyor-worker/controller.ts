...
import type { ConveyorRequest, ConveyorResponse, SimCommand } from "@legacy/scenes/conveyor-worker/protocol";
import type { BeltVariant } from "@legacy/scenes/conveyor-worker/types";
import type { ConveyorItemTypeConfig } from "@legacy/scenes/conveyor-worker/renderer";
import { ConveyorItemRenderer } from "@legacy/scenes/conveyor-worker/renderer";
import type { Renderer } from "@engine/render";
import ConveyorSimulationWorker from "@legacy/scenes/conveyor-worker/simulation.worker?worker";
