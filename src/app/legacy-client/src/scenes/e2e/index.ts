...
import { spawnGear } from "@legacy/entities/gear";
import { GhostPreviewComponent } from "@legacy/entities/ghost";
...
import { destroyTransportBelt, spawnTransportBelt } from "@legacy/entities/transport-belt";
import { ConveyorUtils } from "@legacy/entities/transport-belt/ConveyorUtils";
import type { TransportBeltEntityId } from "@legacy/entities/transport-belt/types";
import { setupContextPlayer } from "@legacy/scenes/world/contexts/shared";
...
import { System as MotionProbeSystem } from "@legacy/systems/e2e/motion-probe";
import { System as BuildModeSystem } from "@legacy/systems/world/build-mode";
...
import { System as ConveyorEntityMotionSystem } from "@legacy/systems/world/conveyor-entity-motion";
