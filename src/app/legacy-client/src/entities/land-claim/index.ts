...
import { LandClaim } from "@legacy/entities/land-claim/component";
import {
...
export { LandClaim } from "@legacy/entities/land-claim/component";
export { LandClaimQuery } from "@legacy/entities/land-claim/LandClaimQuery";
