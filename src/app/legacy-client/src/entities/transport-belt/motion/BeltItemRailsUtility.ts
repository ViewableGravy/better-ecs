import type { ConveyorSide, ConveyorSlotIndex } from "@legacy/components/conveyor-belt";
import { TRANSPORT_BELT_HALF_SIZE, type TransportBeltDirection, type TransportBeltFlow } from "@legacy/entities/transport-belt/consts";
import {
