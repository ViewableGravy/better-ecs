...
import type { TransportBeltVariant } from "@legacy/entities/transport-belt/consts";
import { CONVEYOR_ANIMATION_PLAYBACK_RATE } from "@legacy/entities/transport-belt/motion/constants";
