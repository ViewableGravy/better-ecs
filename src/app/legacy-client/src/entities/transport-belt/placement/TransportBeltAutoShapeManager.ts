import { ConveyorBeltComponent, syncConveyorBeltDirectionsFromVariant } from "@legacy/components/conveyor-belt";
import {
    TRANSPORT_BELT_DIRECTIONS,
    TransportBeltConnectionUtils,
    updateTransportBeltVariant,
} from "@legacy/entities/transport-belt";
import { TransportBeltGridQuery } from "@legacy/entities/transport-belt/core";
...
import { TransportBeltTerminalDecorationManager } from "@legacy/entities/transport-belt/placement/TransportBeltTerminalDecorationManager";
