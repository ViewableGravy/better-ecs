import { LandClaimQuery } from "@legacy/entities/land-claim";
import { Placeable } from "@legacy/systems/world/build-mode/components/placeable";
import type { GridCoordinate, GridCoordinates } from "@legacy/systems/world/build-mode/grid-singleton";
import {
    PlacementFootprintUtils,
    type PlacementFootprint,
} from "@legacy/systems/world/build-mode/placement/footprint";
