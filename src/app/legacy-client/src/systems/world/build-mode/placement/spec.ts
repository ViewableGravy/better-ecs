import type { PlacementFootprint } from "@legacy/systems/world/build-mode/placement/footprint";
import type { PlacementPreviewAdapter } from "@legacy/systems/world/build-mode/placement/preview";
import {
    createPlacementCanPlace,
    createPlacementEvaluator,
    type PlacementEvaluator,
    type PlacementStrategy,
} from "@legacy/systems/world/build-mode/placement/rules";
import type {
    PlacementCanPlace,
    PlacementContext,
    PlacementDragMode,
