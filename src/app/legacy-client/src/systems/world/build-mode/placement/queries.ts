...
import { destroyTransportBelt } from "@legacy/entities/transport-belt";
import { TransportBeltAutoShapeManager } from "@legacy/entities/transport-belt/placement/TransportBeltAutoShapeManager";
import { destroyPlaceableWall, PlaceableWallAutoShapeManager, PlaceableWallComponent } from "@legacy/entities/wall";
import { PhysicsWorldManager } from "@legacy/scenes/world/physics/physics-world-manager";
import { GridNeighborQuery } from "@legacy/systems/world/build-mode/grid-neighbor-query";
import {
    GridSingleton,
