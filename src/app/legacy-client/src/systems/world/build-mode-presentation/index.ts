import { GhostUtils } from "@legacy/entities/ghost";
import { getLocalPlayerOwnerId } from "@legacy/entities/player/actions";
...
import { BuildModeDomEvents } from "@legacy/systems/world/build-mode/dom/events";
import { HUDManager } from "@legacy/systems/world/build-mode/dom/hud";
import { resolveActivePlacement } from "@legacy/systems/world/build-mode/utils";
